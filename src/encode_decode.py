...
def encoder_decoder_pass(x, delta_t, optical_flows, is_training):
    ...
    pool_1_out_op = tf.layers.dropout(pool_1_out_op, rate = 0.8, training = is_training) # dropout
    ...
    pool_2_out_op = tf.layers.dropout(pool_2_out_op, rate = 0.8, training = is_training) # dropout
    ...
    pool_3_out_op = tf.layers.dropout(pool_3_out_op, rate = 0.8, training = is_training) # dropout
    ...
    fc_op_1_out = tf.layers.dropout(fc_op_1_out, rate = 0.8, training = is_training) # dropout
